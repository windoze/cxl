#ifndef CXL_REFLECTION_REFLECTION_IMPL_HPP
#define CXL_REFLECTION_REFLECTION_IMPL_HPP
...
namespace std {
    template<std::size_t I, typename T>
    std::enable_if_t<cxl::reflectable<T> && !cxl::reflection::reflected_element<I, T>::use_value,
                     cxl::reflection::reflected_element_type<I, T>> &
    get(T &t)
    {
        return cxl::reflection::reflected_element<I, T>::get(t);
    }
    ...
    template<std::size_t I, typename T>
    std::enable_if_t<cxl::reflectable<T> && !cxl::reflection::reflected_element<I, T>::use_value,
                     cxl::reflection::reflected_element_type<I, T>> const &
    get(T const &t)
    {
        return cxl::reflection::reflected_element<I, T>::get(t);
    }
...
#endif // !defined(CXL_REFLECTION_REFLECTION_IMPL_HPP)
